namespace Contonso.Common.Domain
{
    /// <summary>
    ...
    public class ServiceResult<TData>
    {
        ...
        public static ServiceResult<TData> Success(TData data)
            => new ServiceResult<TData>(ServiceResultStatus.Success, data);
        ...
        public static ServiceResult<TData> Created(TData data)
            => new ServiceResult<TData>(ServiceResultStatus.Created, data);
        ...
        public static ServiceResult<TData> ValidationError()
            => new ServiceResult<TData>(ServiceResultStatus.BadRequest);
        ...
        public static ServiceResult<TData> NotFound()
            => new ServiceResult<TData>(ServiceResultStatus.NotFound);
        ...
        public static ServiceResult<TData> ShouldExist(TData data)
            => data != null ? Success(data) : NotFound();
    }
}
